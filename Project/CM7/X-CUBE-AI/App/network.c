...
#define AI_NETWORK_MODEL_SIGNATURE     "0xd0ba372eed8202cb509e4e05309231de"
...
#define AI_TOOLS_DATE_TIME   "Fri Jun 14 09:25:49 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 4, 20), AI_STRIDE_INIT(4, 4, 4, 16, 64),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 20, 8, 2), AI_STRIDE_INIT(4, 4, 4, 80, 640),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 5, 5, 10), AI_STRIDE_INIT(4, 4, 4, 40, 200),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 10, 5, 5, 20), AI_STRIDE_INIT(4, 4, 40, 800, 4000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 320, 10, 1, 1), AI_STRIDE_INIT(4, 4, 1280, 12800, 12800),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 24, 2), AI_STRIDE_INIT(4, 4, 4, 40, 960),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 12, 12), AI_STRIDE_INIT(4, 4, 4, 40, 480),
...
AI_LAYER_OBJ_DECLARE(
  _conv2_conv2_0_Conv_output_0_layer, 9,
...
AI_LAYER_OBJ_DECLARE(
  _conv1_conv1_0_Conv_output_0_layer, 6,
  OPTIMIZED_CONV2D_TYPE, 0x0, NULL,
  conv2d_nl_pool, forward_conv2d_if32of32wf32_nl_pool,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 33960, 1, 1),
    33960, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &_conv1_conv1_0_Conv_output_0_layer, 0x94b81b7d, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_network_activations_map[0] + 3920);
    input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3920);
    _conv1_conv1_0_Conv_output_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 7056);
    _conv1_conv1_0_Conv_output_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 7056);
    ...
    _conv2_conv2_0_Conv_output_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 5760);
    _conv2_conv2_0_Conv_output_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 5760);
    _conv2_conv2_0_Conv_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 7040);
    _conv2_conv2_0_Conv_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7040);
    ...
    output_output_array.data = AI_PTR(g_network_activations_map[0] + 1280);
    output_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1280);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    _conv1_conv1_0_Conv_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 1000);
    _conv1_conv1_0_Conv_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1000);
    _conv2_conv2_0_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _conv2_conv2_0_Conv_output_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 1040);
    _conv2_conv2_0_Conv_output_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1040);
    _conv2_conv2_0_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _conv2_conv2_0_Conv_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 21040);
    _conv2_conv2_0_Conv_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 21040);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_weights_map[0] + 21120);
    output_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 21120);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_weights_map[0] + 33920);
    output_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 33920);
    return true;
  }
